...
ifeq ($(v), tr)
    ...
    ODIR := sobjs
    shaders =  finalSol.frag finalSol.vert lightingSol.frag lightingSol.vert reflSol.frag reflSol.vert shadowSol.frag shadowSol.vert 
...
zip:
	...
	cp -r $(extraFiles) $(iblExtras) $(pkgDir)/$(pkgName)
