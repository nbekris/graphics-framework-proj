...
1. 
**G-Buffer Pass:** Scene data is written to three separate floating-point textures within a Framebuffer Object (FBO) using Multiple Render Targets (MRT).
...
2. 
**Global Lighting Pass:** Executes lighting calculations in screen space using a full-screen quad and includes global ambient light.
